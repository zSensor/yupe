...
INSERT INTO `User` (`id`, `creation_date`, `change_date`, `firstName`, `lastName`, `nick_name`, `email`, `gender`, `password`, `salt`, `status`, `accessLevel`, `lastVisit`, `registrationDate`, `registrationIp`, `activationIp`, `avatar`, `useGravatar`) VALUES
